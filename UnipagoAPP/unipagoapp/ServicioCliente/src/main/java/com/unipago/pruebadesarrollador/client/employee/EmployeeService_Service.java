 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://service.pruebadesarrollador.unipago.com/", wsdlLocation = "http://localhost:8080/servicioweb/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://service.pruebadesarrollador.unipago.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/servicioweb/EmployeeService?wsdl");
    ...
    public EmployeeService getEmployeeServicePort() {
        return super.getPort(new QName("http://service.pruebadesarrollador.unipago.com/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.pruebadesarrollador.unipago.com/", "EmployeeServicePort"), EmployeeService.class, features);
    }
